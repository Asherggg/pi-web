...
export function useAgentSession(opts: UseAgentSessionOptions) {
  ...
  }, [applyLoadedAgentState, setToolPresetState]);
  ...
  return {
    ...
    handleToolPresetChange, handleThinkingLevelChange, loadTools, loadMcpToolCatalog, loadSlashCommands, setActiveLeafId, setData, setMessages, loadContext,
