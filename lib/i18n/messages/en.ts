...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "common.personalization": "Personalize",
    ...
    "personalization.background": "Background image",
    "personalization.noBackground": "No image selected",
    "personalization.uploadImage": "Choose image",
    "personalization.replaceImage": "Replace image",
    "personalization.removeImage": "Remove background image",
    "personalization.imageVisibility": "Image visibility",
    "personalization.imageFit": "Image fit",
    "personalization.fitCover": "Fill",
    "personalization.fitContain": "Fit",
    "personalization.completionSound": "Completion sound",
    "personalization.soundClassic": "Classic",
    "personalization.soundSoft": "Soft",
    "personalization.soundBright": "Bright",
    "personalization.soundCustom": "Custom",
    "personalization.uploadSound": "Choose audio",
    "personalization.replaceSound": "Replace audio",
    "personalization.removeSound": "Remove custom audio",
    "personalization.previewSound": "Preview",
    "personalization.volume": "Volume",
    "personalization.backgroundError.invalid-type": "Choose a PNG, JPEG, WebP, GIF, AVIF, or BMP image.",
    "personalization.backgroundError.too-large": "The image must be 20 MB or smaller.",
    "personalization.backgroundError.storage": "The background could not be saved in this browser.",
    "personalization.soundError.invalid-type": "Choose a supported audio file.",
    "personalization.soundError.too-large": "The audio file must be 10 MB or smaller.",
    "personalization.soundError.too-long": "The completion sound must be 15 seconds or shorter.",
    "personalization.soundError.decode": "This audio file could not be decoded by the browser.",
    "personalization.soundError.storage": "The completion sound could not be saved in this browser.",
    ...
    "system.label": "System",
    "sessionMap.title": "Session map",
    "sessionMap.label": "Map",
    "sessionMap.brand": "Pi session map",
    "sessionMap.workspace": "Workspace",
    "sessionMap.sessions": "Sessions",
    "sessionMap.workspaceSessions": "Workspace sessions",
    "sessionMap.unnamed": "Untitled session",
    "sessionMap.branch": "Branch",
    "sessionMap.session": "Session",
    "sessionMap.viewSwitch": "View switcher",
    "sessionMap.chat": "Chat",
    "sessionMap.arrange": "Arrange nodes",
    "sessionMap.focus": "Focus current node",
    "sessionMap.zoomOut": "Zoom out",
    "sessionMap.zoomIn": "Zoom in",
    "sessionMap.close": "Close session map",
    "sessionMap.truncated": "This map is large. Only the most recent nodes are shown.",
    "sessionMap.loading": "Building session map…",
    "sessionMap.emptyTitle": "This workspace has no conversations to map yet.",
    "sessionMap.emptyBody": "Send a message, then open the session map again.",
    "sessionMap.drag": "Drag card; use arrow keys for precise movement",
    "sessionMap.dragNode": "Move {title}",
    "sessionMap.turn": "Turn {count}",
    "sessionMap.tools": "{count} tools",
    "sessionMap.waiting": "Waiting for assistant reply",
    "sessionMap.select": "Select",
    "sessionMap.createFork": "Create an independent session branch",
    "sessionMap.forking": "Creating",
    "sessionMap.openChat": "Open chat",
    "sessionMap.runningNavigate": "This session is running. Historical nodes cannot be selected yet.",
    "sessionMap.runningFork": "This session is running. A branch cannot be created yet.",
    ...
    "chat.showMcpTools": "Show MCP tools",
    "chat.hideMcpTools": "Hide MCP tools",
    "chat.loadingMcpTools": "Loading MCP tools...",
    "chat.mcpToolsUnavailable": "MCP tools are unavailable for this session.",
    "chat.noMcpTools": "No tools loaded",
    "chat.mcpToolCount": "{count} tool",
    "chat.mcpToolsCount": "{count} tools",
    "chat.mcpToolsLoaded": "{count} tools loaded",
    "chat.close": "Close",
