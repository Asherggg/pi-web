...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "personalization.title": "个性化设置",
    "personalization.background": "背景图片",
    "personalization.noBackground": "未选择图片",
    "personalization.uploadImage": "选择图片",
    "personalization.replaceImage": "更换图片",
    "personalization.removeImage": "移除背景图片",
    "personalization.imageVisibility": "图片显示强度",
    "personalization.imageFit": "图片适配",
    "personalization.fitCover": "铺满",
    "personalization.fitContain": "完整显示",
    "personalization.completionSound": "完成提示音",
    "personalization.soundClassic": "经典",
    "personalization.soundSoft": "柔和",
    "personalization.soundBright": "清亮",
    "personalization.soundCustom": "自定义",
    "personalization.uploadSound": "选择音频",
    "personalization.replaceSound": "更换音频",
    "personalization.removeSound": "移除自定义音频",
    "personalization.previewSound": "试听",
    "personalization.volume": "音量",
    "personalization.backgroundError.invalid-type": "请选择 PNG、JPEG、WebP、GIF、AVIF 或 BMP 图片。",
    "personalization.backgroundError.too-large": "图片大小不能超过 20 MB。",
    "personalization.backgroundError.storage": "无法在当前浏览器中保存背景图片。",
    "personalization.soundError.invalid-type": "请选择受支持的音频文件。",
    "personalization.soundError.too-large": "音频文件大小不能超过 10 MB。",
    "personalization.soundError.too-long": "完成提示音不能超过 15 秒。",
    "personalization.soundError.decode": "浏览器无法解码此音频文件。",
    "personalization.soundError.storage": "无法在当前浏览器中保存完成提示音。",
    "history.full": "完整历史",
    ...
    "system.label": "系统",
    "sessionMap.title": "会话地图",
    "sessionMap.label": "会话地图",
    "sessionMap.brand": "Pi 会话地图",
    "sessionMap.workspace": "工作区",
    "sessionMap.sessions": "会话",
    "sessionMap.workspaceSessions": "工作区会话",
    "sessionMap.unnamed": "未命名会话",
    "sessionMap.branch": "分支",
    "sessionMap.session": "会话",
    "sessionMap.viewSwitch": "视图切换",
    "sessionMap.chat": "对话",
    "sessionMap.arrange": "整理节点",
    "sessionMap.focus": "定位当前节点",
    "sessionMap.zoomOut": "缩小",
    "sessionMap.zoomIn": "放大",
    "sessionMap.close": "关闭会话地图",
    "sessionMap.truncated": "会话地图较大，当前仅显示最近的部分节点。",
    "sessionMap.loading": "正在构建会话地图…",
    "sessionMap.emptyTitle": "当前工作区还没有可投影的问答。",
    "sessionMap.emptyBody": "发送一条消息后再打开会话地图。",
    "sessionMap.drag": "拖动卡片；方向键可微调位置",
    "sessionMap.dragNode": "移动 {title}",
    "sessionMap.turn": "第 {count} 轮",
    "sessionMap.tools": "{count} 个工具",
    "sessionMap.waiting": "等待助手回复",
    "sessionMap.select": "选择",
    "sessionMap.createFork": "创建独立会话分支",
    "sessionMap.forking": "创建中",
    "sessionMap.openChat": "打开对话",
    "sessionMap.runningNavigate": "会话运行中，暂时不能切换历史节点。",
    "sessionMap.runningFork": "会话运行中，暂时不能创建分支。",
    "tools.label": "工具",
    "tools.title": "工具定义",
    ...
    "chat.showMcpTools": "显示 MCP 工具",
    "chat.hideMcpTools": "收起 MCP 工具",
    "chat.loadingMcpTools": "正在加载 MCP 工具...",
    "chat.mcpToolsUnavailable": "当前会话无法读取 MCP 工具。",
    "chat.noMcpTools": "没有已加载的工具",
    "chat.mcpToolCount": "{count} 个工具",
    "chat.mcpToolsCount": "{count} 个工具",
    "chat.mcpToolsLoaded": "已加载 {count} 个工具",
    "chat.close": "关闭",
