...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "theme.pine": "主題：松夜",
    "theme.auto": "主題：跟隨系統",
    "personalization.title": "個人化設定",
    "personalization.background": "背景圖片",
    "personalization.noBackground": "未選擇圖片",
    "personalization.uploadImage": "選擇圖片",
    "personalization.replaceImage": "更換圖片",
    "personalization.removeImage": "移除背景圖片",
    "personalization.imageVisibility": "圖片顯示強度",
    "personalization.imageFit": "圖片適配",
    "personalization.fitCover": "填滿",
    "personalization.fitContain": "完整顯示",
    "personalization.completionSound": "完成提示音",
    "personalization.soundClassic": "經典",
    "personalization.soundSoft": "柔和",
    "personalization.soundBright": "清亮",
    "personalization.soundCustom": "自訂",
    "personalization.uploadSound": "選擇音訊",
    "personalization.replaceSound": "更換音訊",
    "personalization.removeSound": "移除自訂音訊",
    "personalization.previewSound": "試聽",
    "personalization.volume": "音量",
    "personalization.backgroundError.invalid-type": "請選擇 PNG、JPEG、WebP、GIF、AVIF 或 BMP 圖片。",
    "personalization.backgroundError.too-large": "圖片大小不能超過 20 MB。",
    "personalization.backgroundError.storage": "無法在目前瀏覽器中儲存背景圖片。",
    "personalization.soundError.invalid-type": "請選擇支援的音訊檔案。",
    "personalization.soundError.too-large": "音訊檔案大小不能超過 10 MB。",
    "personalization.soundError.too-long": "完成提示音不能超過 15 秒。",
    "personalization.soundError.decode": "瀏覽器無法解碼此音訊檔案。",
    "personalization.soundError.storage": "無法在目前瀏覽器中儲存完成提示音。",
    "history.full": "完整紀錄",
    ...
    "sessionMap.title": "工作階段地圖",
    "sessionMap.label": "地圖",
    "sessionMap.brand": "Pi 工作階段地圖",
    "sessionMap.workspace": "工作區",
    "sessionMap.sessions": "工作階段",
    "sessionMap.workspaceSessions": "工作區工作階段",
    "sessionMap.unnamed": "未命名工作階段",
    "sessionMap.branch": "分支",
    "sessionMap.session": "工作階段",
    "sessionMap.viewSwitch": "檢視切換",
    "sessionMap.chat": "對話",
    "sessionMap.arrange": "整理節點",
    "sessionMap.focus": "定位目前節點",
    "sessionMap.zoomOut": "縮小",
    "sessionMap.zoomIn": "放大",
    "sessionMap.close": "關閉工作階段地圖",
    "sessionMap.truncated": "工作階段地圖較大，目前僅顯示最近的部分節點。",
    "sessionMap.loading": "正在建立工作階段地圖…",
    "sessionMap.emptyTitle": "目前工作區還沒有可顯示的對話。",
    "sessionMap.emptyBody": "傳送一則訊息後再開啟工作階段地圖。",
    "sessionMap.drag": "拖曳卡片；方向鍵可微調位置",
    "sessionMap.dragNode": "移動 {title}",
    "sessionMap.turn": "第 {count} 輪",
    "sessionMap.tools": "{count} 個工具",
    "sessionMap.waiting": "等待助理回覆",
    "sessionMap.select": "選取",
    "sessionMap.createFork": "建立獨立工作階段分支",
    "sessionMap.forking": "建立中",
    "sessionMap.openChat": "開啟對話",
    "sessionMap.runningNavigate": "工作階段執行中，暫時無法切換歷史節點。",
    "sessionMap.runningFork": "工作階段執行中，暫時無法建立分支。",
    "session.info": "工作階段資訊",
    "session.name": "名稱",
    "session.file": "工作階段檔案",
    ...
    "chat.showMcpTools": "顯示 MCP 工具",
    "chat.hideMcpTools": "收合 MCP 工具",
    "chat.loadingMcpTools": "正在載入 MCP 工具...",
    "chat.mcpToolsUnavailable": "目前工作階段無法讀取 MCP 工具。",
    "chat.noMcpTools": "沒有已載入的工具",
    "chat.mcpToolCount": "{count} 個工具",
    "chat.mcpToolsCount": "{count} 個工具",
    "chat.mcpToolsLoaded": "已載入 {count} 個工具",
    "chat.close": "關閉",
