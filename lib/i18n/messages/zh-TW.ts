...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "personalization.noBackground": "尚未選擇圖片",
    ...
    "personalization.backgroundError.too-large": "圖片大小不得超過 20 MB。",
    "personalization.backgroundError.storage": "無法在此瀏覽器中儲存背景圖片。",
    "personalization.soundError.invalid-type": "請選擇支援的音訊檔案。",
    "personalization.soundError.too-large": "音訊檔案大小不得超過 10 MB。",
    "personalization.soundError.too-long": "完成提示音不得超過 15 秒。",
    "personalization.soundError.decode": "瀏覽器無法解碼此音訊檔案。",
    "personalization.soundError.storage": "無法在此瀏覽器中儲存完成提示音。",
    "history.full": "完整紀錄",
    ...
    "sessionMap.truncated": "地圖內容較大，目前只顯示最近的節點。",
    "sessionMap.loading": "正在建立工作階段地圖…",
    "sessionMap.emptyTitle": "此工作區尚無可顯示的對話。",
    "sessionMap.emptyBody": "傳送訊息後再開啟工作階段地圖。",
    "sessionMap.drag": "拖曳卡片；可用方向鍵精細調整位置",
    ...
    "sessionMap.runningNavigate": "此工作階段正在執行，暫時無法選取歷史節點。",
    "sessionMap.runningFork": "此工作階段正在執行，暫時無法建立分支。",
    "tools.label": "工具",
    "tools.title": "工具定義",
